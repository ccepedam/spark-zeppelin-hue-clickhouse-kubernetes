...
#export ZEPPELIN_SSL_PORT=7443

export SPARK_SUBMIT_OPTIONS="--packages ru.yandex.clickhouse:clickhouse-jdbc:0.1.34 --jars /usr/local/spark/myscripts/gcs-connector-latest-hadoop2.jar,/usr/local/spark/myscripts/clickhouse-jdbc-0.1-SNAPSHOT.jar"
export MASTER=spark://spark-master-service:7077
export SPARK_HOME=/usr/local/spark
export JAVA_HOME=/usr
export ZEPPELIN_PORT=7000
export ZEPPELIN_NOTEBOOK_DIR=/zeppelin/notebook
export ZEPPELIN_LOG_DIR=/zeppelin/logs
